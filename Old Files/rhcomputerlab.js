...
let buildingName = 'Rockwell Hall.';
...
function catStudyRooms() {
    let roomList = ['','RH 037 Computer Lab','RH 037A','RH 037B','RH 037C',
                    ...
                    'RW 205 Study Room','RW Lobby','RW 008'];
...
function updateMap() {
    ...
    if (newVal === '' && iframe.src === 'https://tinyurl.com/SCLdefault') {
        iframe.src = 'https://tinyurl.com/SCLdefaultz';
        return;
    }
    ...
    if (adaCheckBox.checked == false) {
        iframe.src = 'https://tinyurl.com/SCL' + newVal;
    }
    else {
        iframe.src = 'https://tinyurl.com/SCL' + newVal + 'z';
    }
}
