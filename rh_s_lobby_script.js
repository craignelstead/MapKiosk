...
function updateMap() {
    ...
    if (newVal === '' && iframe.src === 'https://tinyurl.com/RHSdefault') {
        iframe.src = 'https://tinyurl.com/RHSdefaultz';
        return;
    }
    ...
    if (adaCheckBox.checked == false) {
        iframe.src = 'https://tinyurl.com/RHS' + newVal;
    }
    else {
        iframe.src = 'https://tinyurl.com/RHS' + newVal + 'z';
    }
}
